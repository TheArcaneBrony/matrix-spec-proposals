# MSC4033: Making room types required

Having a missing room type and leaving the client up to guessing what to do is vague and best. 
This leads to indeterminate behavior, eg. when clients render policy rooms.
